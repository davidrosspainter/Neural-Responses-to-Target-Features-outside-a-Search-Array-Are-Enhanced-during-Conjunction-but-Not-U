...
%% save data_trial, data_present, data_stimulus, data_check

out_names = {   'data_trial', 'data_present', 'data_stimulus', 'data_check'};
...
% delete 'data_trial.txt' 'data_present.txt' 'data_stimulus.txt' 'data_check.txt'
...
for a = 1:4
    ...
    switch a
        ...
        case 3
            ...
            for trialcount = 1:num_trials
                for display = 1:num_displays
                    temp1 = [ temp1; [ repmat(data_stimulus{trialcount,1}(display,1:2),3,1), data_stimulus{trialcount,display+1} ] ];
                end
            end
        ...
        case 4
            dlmwrite(out_name, data_check,'-append','delimiter','	');
    end
